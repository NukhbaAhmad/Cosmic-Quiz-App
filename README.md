...
1. `[[git clone https://github.com/NukhbaAhmad/Quiz-App-.git](https://github.com/NukhbaAhmad/Cosmic-Quiz-App.git)](https://github.com/NukhbaAhmad/Cosmic-Quiz-App.git)`
2. `cd CosmoQuiz`
